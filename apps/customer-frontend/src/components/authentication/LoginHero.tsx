          ...
          <div className="flex items-center gap-16 overflow-hidden rounded-4xl bg-white py-2.5 pr-2.5 dark:bg-black">
            <RevealAnimation delay={0.1}>
              <div className="w-full max-w-[400px] px-8 py-14">
                <form className="mb-6" method="post" action="/talent/login">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Link href="/talent/forgot-password" className="text-tagline-2 text-secondary dark:text-accent font-medium underline">
                      Forgot password?
                    </Link>
                  </div>
                  <div className="mt-8">
